...
class UserGroupsControllerTest < ActionController::TestCase
  ...
  test "should create user_group" do
    assert_difference('UserGroup.count') do
      post :create, user_group: { admin_id: @user_group.admin_id, description: @user_group.description, group_name: @user_group.group_name }
    end
  ...
  test "should update user_group" do
    patch :update, id: @user_group, user_group: { admin_id: @user_group.admin_id, description: @user_group.description, group_name: @user_group.group_name }
    assert_redirected_to user_group_path(assigns(:user_group))
  end
